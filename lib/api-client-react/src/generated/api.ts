...
export const getListChecklistTemplatesUrl = () => {
  return `/api/settings/checklist-templates`;
};
...
export const getListChecklistTemplatesQueryKey = () => {
  return [`/api/settings/checklist-templates`] as const;
};
...
export const createChecklistTemplate = async (
  createChecklistTemplateBody: CreateChecklistTemplateBody,
  options?: RequestInit,
): Promise<ChecklistTemplate> => {
  return customFetch<ChecklistTemplate>(getCreateChecklistTemplateUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(createChecklistTemplateBody),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<CreateChecklistTemplateBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type CreateChecklistTemplateMutationBody =
  BodyType<CreateChecklistTemplateBody>;
...
export const getCreateChecklistTemplateItemForTemplateUrl = (id: string) => {
  return `/api/settings/checklist-templates/${id}/items`;
};

export const createChecklistTemplateItemForTemplate = async (
  id: string,
  createChecklistTemplateItemBody: CreateChecklistTemplateItemBody,
  options?: RequestInit,
): Promise<ChecklistTemplateItem> => {
  return customFetch<ChecklistTemplateItem>(
    getCreateChecklistTemplateItemForTemplateUrl(id),
    {
      ...options,
      method: "POST",
      headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getCreateChecklistTemplateItemForTemplateMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof createChecklistTemplateItemForTemplate>>,
    TError,
    { id: string; data: BodyType<CreateChecklistTemplateItemBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["createChecklistTemplateItemForTemplate"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return createChecklistTemplateItemForTemplate(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type CreateChecklistTemplateItemForTemplateMutationResult = NonNullable<
  Awaited<ReturnType<typeof createChecklistTemplateItemForTemplate>>
>;
export type CreateChecklistTemplateItemForTemplateMutationBody =
  BodyType<CreateChecklistTemplateItemBody>;
export type CreateChecklistTemplateItemForTemplateMutationError =
  ErrorType<ErrorResponse>;

export const useCreateChecklistTemplateItemForTemplate = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  return useMutation(
    getCreateChecklistTemplateItemForTemplateMutationOptions(options),
  );
};
...
export const updateChecklistTemplateItem = async (
  ...
  return customFetch<ChecklistTemplateItem>(
    getUpdateChecklistTemplateItemUrl(id),
    {
      ...options,
      method: "POST",
      headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getUpdateChecklistTemplateItemMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateChecklistTemplateItem>>,
    TError,
    { id: string; data: BodyType<CreateChecklistTemplateItemBody> },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["updateChecklistTemplateItem"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return updateChecklistTemplateItem(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type UpdateChecklistTemplateItemMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateChecklistTemplateItem>>
>;
export type UpdateChecklistTemplateItemMutationBody =
  BodyType<CreateChecklistTemplateItemBody>;
export type UpdateChecklistTemplateItemMutationError = ErrorType<ErrorResponse>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getUpdateChecklistTemplateItemMutationOptions(options));
};
...
export const getListChecklistsUrl = (params?: ListChecklistsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/checklists?${stringifiedParams}`
    : `/api/checklists`;
};
...
export const listChecklists = async (
  ...
  return customFetch<EventChecklist[]>(getListChecklistsUrl(params), {
    ...options,
    method: "GET",
  });
};
...
export const getListChecklistsQueryKey = (params?: ListChecklistsParams) => {
  return [`/api/checklists`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listChecklists>>> = ({
    signal,
  }) => listChecklists(params, { signal, ...requestOptions });
...
export const createChecklist = async (
  ...
  return customFetch<EventChecklist>(getCreateChecklistUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(createChecklistBody),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<CreateChecklistBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type CreateChecklistMutationResult = NonNullable<
  Awaited<ReturnType<typeof createChecklist>>
>;
export type CreateChecklistMutationBody = BodyType<CreateChecklistBody>;
export type CreateChecklistMutationError = ErrorType<ErrorResponse>;
...
export const updateChecklistItem = async (
  ...
  return customFetch<EventChecklistItem>(getUpdateChecklistItemUrl(id), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(updateChecklistItemBody),
